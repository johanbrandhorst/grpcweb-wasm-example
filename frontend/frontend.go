...
//go:generate bash -c "GOOS=js GOARCH=wasm go1.11beta2 build -o ./html/test.wasm frontend.go"

//go:generate bash -c "cp $DOLLAR(go1.11beta2 env GOROOT)/misc/wasm/wasm_exec.html ./html/index.html"
//go:generate bash -c "cp $DOLLAR(go1.11beta2 env GOROOT)/misc/wasm/wasm_exec.js ./html/wasm_exec.js"
...
//go:generate bash -c "go1.11beta2 run assets_generate.go"
